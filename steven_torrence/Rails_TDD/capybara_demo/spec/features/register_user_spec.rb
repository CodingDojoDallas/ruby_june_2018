...
feature "User creates an account" do
  ...
  scenario "successfully creates a new user account" do
    fill_in "user_first_name", with: "Steven"
    fill_in "user_last_name", with: "Torrence"
    fill_in "user_email", with: "storrence88@gmail.com"
    click_button "Create User"
    expect(page).to have_content "Welcome, Steven Torrence"
