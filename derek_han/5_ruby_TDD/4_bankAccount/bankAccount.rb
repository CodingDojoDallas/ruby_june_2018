class BankAccount
	...
	def withdraw(account, amount)
		if account == "checking"
			if amount > @checking
				print "Checking has insufficient funds"
			else
				@checking -= amount
			end
		elsif account == "savings"
			if amount > @savings
				print "Your saving account not enough money"
	...
	def get_account_number
		print "Really want to know your account number??"
		@account_number
	end
end
